...
module.exports = {
    ...
    scanInterval: 15000,  // Scan every 30 seconds
...
'SUI/USD',
    ...
    strategies: {
        ...
        momentum: {
            ...
            minConfidence: 0.80,         // 65% min confidence for entry 0.65 (going for 80%)
            ...
            minADX: 30,                  // Only trade when trending, was 25
        ...
        meanReversion: {
            enabled: true,
            timeframe: '15m',
            minConfidence: 0.70,         // Only high-quality setups  0.7
            maxADX: 25,                  //  Added by me
            zScoreEntry: 2.0,            // 2 standard deviations
            zScoreExit: 0.5,             // Exit when normalizing
            // Bollinger Bands
            bbPeriod: 20,
            bbStdDev: 2,
            // Keltner Channels
            ...
            // RSI
            rsiPeriod: 14,
            rsiOversold: 30,             // Institutional threshold
            rsiOverbought: 70,
            // Volume
            volumeMultiplier: 1.3,       // Require volume confirmation
            // Half-Life
            minHalfLife: 5,              // was 3 and back to 5
            maxHalfLife: 200,
            // ADX - only trade ranging markets
        },
