...
class MomentumAnalyzer:
    ...
    def calculate_momentum(self, symbol: str, minutes: int = 15) -> Optional[Dict]:
        """Calculate price momentum from current candle interval start (00, 15, 30, 45)."""
        ...
        # Find start of current 15-min interval (floor to :00, :15, :30, :45)
        ...
        # Get all prices from current candle start to now
        cutoff = candle_start
